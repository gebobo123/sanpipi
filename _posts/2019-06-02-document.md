...
<script src="https://files.cnblogs.com/files/fenggwsx/clipboard.min.js"></script>sudo apt-get update<script src="https://files.cnblogs.com/files/fenggwsx/cp.js"></script>
